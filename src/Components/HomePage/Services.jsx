  ...
  return (
    <div className='w-full h-[40vh] mt-6'>
        ...
        <div className="ServicesContainer flex justify-around items-center  gap-30 mt-12 md:flex md:flex-col md:m-auto md:mt-10 md:gap-12 xl:flex-wrap xl:gap-32">
              <div className="item w-[215px] h-[215px] shadow  flex flex-col justify-center items-center rounded-2xl hover:shadow-inner bg-white relative">
                    <div className="servicesimage m-auto"> <img src={ItInfrastructure} alt="ItInfrastructure" className='object-center'/></div>
                ...
                <div className="item w-[215px] h-[215px] shadow flex flex-col justify-center items-center rounded-2xl hover:shadow-inner bg-white relative">
                    ...
                    <h1 className='text-sm text-center mb-4 absolute -bottom-12 text-[#939393]'>Managed Security Services</h1>
                </div>  
                <div className="item w-[215px] h-[215px] shadow flex flex-col justify-center items-center rounded-2xl hover:shadow-inner bg-white relative">
                ...
                <div className="item w-[215px] h-[215px] shadow flex flex-col justify-center items-center rounded-2xl hover:shadow-inner bg-white relative">
                    ...
                    <h1 className='text-sm text-center mb-4 absolute -bottom-12 text-[#939393]'>Cloud and Security Services</h1>
                </div>  
        </div>
